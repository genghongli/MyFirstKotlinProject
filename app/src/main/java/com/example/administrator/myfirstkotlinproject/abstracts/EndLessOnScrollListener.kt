package com.example.administrator.myfirstkotlinproject.abstracts

import android.support.v7.widget.LinearLayoutManager
import android.support.v7.widget.RecyclerView

open class EndLessOnScrollListener:RecyclerView.OnScrollListener()
{
    val  TAG =  "EndLessOnScrollListener";
...
//去掉loading也可以，但是性能会下降，在每次滑动时都会判断，所以的加上
    ...
    *//**
    ...
    作者：HeTingwei
    来源：CSDN
    原文：https://blog.csdn.net/htwhtw123/article/details/77917403
